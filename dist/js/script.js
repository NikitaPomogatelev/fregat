...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_heroSlider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/heroSlider */ "./src/js/modules/heroSlider.js");
/* harmony import */ var _modules_placingSlider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/placingSlider */ "./src/js/modules/placingSlider.js");
/* harmony import */ var _modules_datePicker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/datePicker */ "./src/js/modules/datePicker.js");
...
/* harmony import */ var _modules_fslightbox__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/fslightbox */ "./src/js/modules/fslightbox.js");
/* harmony import */ var _modules_feedbackSlider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/feedbackSlider */ "./src/js/modules/feedbackSlider.js");
/* harmony import */ var _modules_breadcrumbsFocus__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/breadcrumbsFocus */ "./src/js/modules/breadcrumbsFocus.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_placingSlider__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_datePicker__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_customSelect__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_modules_fslightbox__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_modules_feedbackSlider__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_modules_breadcrumbsFocus__WEBPACK_IMPORTED_MODULE_6__["default"])();
});

/***/ }),

/***/ "./src/js/modules/breadcrumbsFocus.js":
/*!********************************************!*\
  !*** ./src/js/modules/breadcrumbsFocus.js ***!
  \********************************************/
/*! exports provided: default */
...
var breadcrumbsFocus = function breadcrumbsFocus() {
  var breadcrumbLink = document.querySelectorAll('.breadcrumb-menu__link');

  if (breadcrumbLink) {
    breadcrumbLink.forEach(function (link) {
...
/* harmony default export */ __webpack_exports__["default"] = (breadcrumbsFocus);
...
/* harmony import */ var vanillajs_datepicker_js_i18n_locales_ru__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vanillajs-datepicker/js/i18n/locales/ru */ "./node_modules/vanillajs-datepicker/js/i18n/locales/ru.js");
...
var datePicker = function datePicker() {
  Object.assign(vanillajs_datepicker__WEBPACK_IMPORTED_MODULE_1__["Datepicker"].locales, vanillajs_datepicker_js_i18n_locales_ru__WEBPACK_IMPORTED_MODULE_2__["default"]);
  var elem = document.querySelector('#range-date');
  var rangepicker = new vanillajs_datepicker__WEBPACK_IMPORTED_MODULE_1__["DateRangePicker"](elem, {
    language: 'ru'
  });
};
...
var feedbackSlider = function feedbackSlider() {
  var feedbackSwiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.feedback-slider', {
    slidesPerView: 3,
    loop: true,
    pagination: {
  ...
  var allIndex = document.querySelectorAll('.feedback-slider .swiper-slide[data-swiper-slide-index]');
  var maxIndex = 0;
  allIndex.forEach(function (el) {
    var a = el.getAttribute('data-swiper-slide-index');

    if (a > maxIndex) {
      return maxIndex = a;
    }
  });
  var sliderCurrent = document.querySelector('.feedback .slider-pagination__current');
  var sliderTotal = document.querySelector('.feedback .slider-pagination__total');

  var printSlideIndex = function printSlideIndex(selector, value) {
    if (value >= 0 && value < 10) {
      selector.innerHTML = "0".concat(value);
    } else {
      selector.innerHTML = "".concat(value);
    }
  };
...
var gallery = function gallery() {
  var galleryBtn = document.querySelector('.gallery__btn');
...
var heroSlider = function heroSlider() {
  var heroSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.hero', {
    loop: true,
    autoplay: {
      delay: 6500
    },
...
var modal = function modal() {
  var btnForm = document.querySelectorAll('.btn-form');
  var modal = document.querySelector('#modal');
  var modalTitle = modal.querySelector('.modal__title');
  var modalBtn = modal.querySelector('.modal__btn');
...
/***/ "./src/js/modules/placingSlider.js":
/*!*****************************************!*\
  !*** ./src/js/modules/placingSlider.js ***!
  \*****************************************/
/*! exports provided: default */
...
var placingSlider = function placingSlider() {
  // console.log(activeIndex);
  var placingSwiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.placing-slider', {
    slidesPerView: 3,
    loop: true,
    pagination: {
  ...
  var allIndex = document.querySelectorAll('.placing-slider .swiper-slide[data-swiper-slide-index]');
  var maxIndex = 0;
  allIndex.forEach(function (el) {
    var a = el.getAttribute('data-swiper-slide-index');
  ...
  var sliderCurrent = document.querySelector('.placing .slider-pagination__current');
  var sliderTotal = document.querySelector('.placing .slider-pagination__total');
...
/* harmony default export */ __webpack_exports__["default"] = (placingSlider);
